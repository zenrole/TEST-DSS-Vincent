...
public class KaryawanServiceImpl implements KaryawanService {
    ...
    @Override
    public KaryawanEntity getUserById(Integer userId) {
        Optional<KaryawanEntity> userOpt = karyawanRepository.findById(userId);
    ...
    @Override
    public void deleteKaryawanId(Integer userId) {
        Optional<KaryawanEntity> userOpt = karyawanRepository.findById(userId);
        if(userOpt.isPresent())
            karyawanRepository.deleteById(userId);
        else
            throw new RuntimeException("user not found.");
    }
